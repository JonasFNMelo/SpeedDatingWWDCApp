...
enum BancoDePerguntas {
    static let paraAlumni: [String] = [
        "Qual foi a coisa mais marcante do seu tempo como estagiário?",
        ...
        "Qual projeto do seu estágio você ainda lembra com carinho?",
        "Como o estágio influenciou na sua carreira hoje?",
        "Qual foi o maior aprendizado que você levou daqui?",
        "Tinha algum ritual ou tradição da sua época que sente falta?",
        "Qual a história mais inesperada que aconteceu no estágio?",
        "Que conselho você daria pra quem tá estagiando agora?",
        "Qual sessão de WWDC ficou marcada pra você e por quê?",
        "Como era acompanhar a WWDC na sua época?",
        "Tem alguma decisão de carreira que você atribui ao estágio?"
    ]
    
    static let paraAluno: [String] = [
        "Qual o projeto mais legal que você tá tocando agora?",
        "O que você mais tá curtindo no estágio até aqui?",
        ...
        "Que skill você quer desenvolver durante o estágio?",
